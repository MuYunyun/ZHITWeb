 ...
 <!--left -->
  <div class="col">
     <div class="sub_nav mb15">
      ...
      <ul>
        ...
        <li><a href="zxfw_1.jsp"><span></span>典型案例</a></li>
        <li><a href="zxfw_2.jsp" class="cur"><span></span>项目对接</a></li>
      </ul>
    </div>      
  </div>
     <!--right -->
  <div class="main">
    <div class="box-header clearfix ovr">
      <h2>产品推广</h2>
      <p class="tree">您的位置：<a href="index.jsp">首页</a>&gt;<a href="zxfw.jsp">咨询服务</a>&gt;项目对接</p>
    </div>
         <div class="news_list neirong3">
</div>
...
var total;           //总共多少记录
 ...
 function Init(pageIndex){
     $.ajax({
	    type: "post",
      url:"../getContentPaixuServ?Cat=17&rows="+pageSize+"&page="+pageIndex,
      async: false,
      ...
      success: function (data) {
	        ...
	        for(var i=0;i<array.length;i++){
	        	...
	        	if(info.refPic != null){
	        	$(".neirong3").append('<dl><h3><a href="sjjm.jsp?ContentId='+info.contentId+'" title="'+info.caption+'" target="_blank">'+info.caption+'</a></h3><dt><a href="sjjm.jsp?ContentId='+info.contentId+'" title="'+info.caption+'" target="_blank"><img src="<%=basePathPic%>'+info.refPic+'" alt="'+info.caption+' width="150" height="95""></a></dt>  <dd class="shortdd">'+info.text+'</dd><span>发布时间：'+info.createDate+'</span></dl>') 
	        	}else{
	        	$(".neirong3").append('<dl ><h3><a href="sjjm.jsp?ContentId='+info.contentId+'" title="'+info.caption+'" target="_blank">'+info.caption+'</a></h3><dd class="shortdd">'+info.text+'</dd><span>发布时间：'+info.createDate+'</span></dl>');
	        	};
	     }   	
      },
      error: function () {
